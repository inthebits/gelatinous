...
The constant system supports:
- **Base anatomy** (standard human form with auto-created defaults)
- **Paired appendages** (left/right differentiation)  
- **Extended anatomy** (additional arms, tails, wings via dictionary expansion)
- **Modular expansion** (new appendage types as needed)
- **Naming conventions** for systematic appendage numbering
- **High limits** (50+ locations supported, unlimited theoretical capacity)
...
1. **Base Description**: Character's main description
2. **Visible Longdescs**: All longdescs for uncovered body parts (head-to-toe anatomical order)
3. **Equipment/Clothing**: Future integration point
4. **Status Effects**: Future integration point (injuries, modifications)
...
- Covered locations hide base longdescs
...
### Validation System
- Location validation against constants
- **Description length limits (1000 characters max)**
...
- Caching for frequently accessed descriptions
