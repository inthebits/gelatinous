MESSAGES = {
    ...
    'miss': [
        ...
        "A full-bodied strike misses by a breath. {attacker}'s follow-through is all control, but the moment crackles with unfinished business.",
        "A miss, but not a mistake. {attacker} recalibrates instantly, brass knuckles still shining like unfinished business.",
        ...
        "Brass knuckles carve an arc through space, missing by inches. But it isn’t a relief — it’s a delay. The real hit is still in the air, waiting.",
        "Brass misses bone by a whisper. {target} exhales too late to feel relief.",
        "Flesh was the target, but air is what the brass bites into. {attacker} resets their stance with cold precision, their breathing unchanged.",
        "It’s a miss. Not a failure. Brass still gleams. Fists still tighten. {attacker} isn't done.",
        "It’s not a swing — it’s a *statement*. And though it misses, the echo in the room treats it like it mattered.",
        "The blow misses, but the sound it makes — sharp, metallic — stays in {target}'s ears like a memory trying to become trauma.",
        ...
        "The ground vibrates faintly where the punch should’ve landed. {target} sidesteps, but their face is pale — they felt the future.",
        "The knuckles flash past {target}'s cheek, heat trailing behind like static from a severed wire. They don’t flinch — but their fingers curl.",
        ...
        "The punch misses, but it *felt* like it hit. The sound alone leaves everyone watching braced for blood that doesn’t come.",
        "The punch whips past {target}'s ear. Close enough to count hairs. Too close to count on that luck again.",
        "The strike doesn’t land, but it pulls the world a little tighter. Everyone feels it. No one breathes.",
        ...
        "The swing passes so close it parts {target}'s hair. They don’t scream, but they definitely don’t smile either.",
        "You could frame the motion — brass blurring through space. It’s beautiful in the way all near-death moments are.",
        ...
        "{attacker} lunges, but {target} moves with just enough grace to slip under. They feel the draft of steel passing, closer than a whisper.",
        "{attacker} overcommits, their knuckles slicing the tension but not the flesh. {target}'s smirk doesn’t last.",
        "{attacker} punches through shadow, not skin. {target} watches, breath hitching, and readies for the sequel.",
        "{attacker} steps in too far, overshooting. {target} pivots, eyes wide, and lives to regret it later.",
        "{attacker} strikes wide, the gleam of brass blinding for a moment. {target} doesn’t cheer — they know it was luck. And luck is running thin.",
        "{attacker} swings wide, the brass catching nothing but air and frustration. {target} breathes a little harder, a little faster.",
        "{attacker} swings with raw intention, the brass whistling through the space where {target}'s head was a second ago. The silence that follows is laced with anticipation and regret.",
        ...
        "{attacker} throws a jab with intent, the kind you don’t fake. It misses, but {target} looks rattled anyway.",
        ...
        "{attacker}'s strike disrupts the air with violent precision. {target} slips away, but the feeling of impact still lingers on their skin.",
        ...
        "{target} pivots just enough to let {attacker}'s punch pass beside them, the force of it tugging air like a promise unfulfilled. Their heart pounds — they were a breath away from blackout.",
