...
* **Brace verbs that follow ``{They}`` / ``{they}`` as their subject** so
  the renderer's ``flex_verb`` pass conjugates them for the apparent
  number/gender. Bare ``{They} hold`` becomes ``He hold`` for a male
  sleeve; braced ``{They} {hold}`` becomes ``He holds``.
...
SHORT_DESCS: list[str] = [
    ...
    "A fine film of grit settles into the creases of {their} skin no matter how recent the wash.",
    ...
    "There is a flat, settled grayness to {their} skin that the colony's lighting does the rest of.",
    ...
    "Something in {their} eyes suggests too many visits to the wrong kind of clinic.",
    ...
    "A streak of something dark — grease, ash, or worse — runs along the line of {their} jaw, half-noticed.",
