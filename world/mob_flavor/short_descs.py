...
SHORT_DESCS: list[str] = [
    ...
    "A faint chemical tang clings to {their} clothes — solvent, smoke, or something the recyclers cannot quite scrub out.",
    ...
    "{Their} clothes have been mended more times than they have been washed.",
    ...
    "{They} have the look of someone who got dressed in the dark and has not been told otherwise.",
