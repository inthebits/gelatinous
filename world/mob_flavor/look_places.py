...
LOOK_PLACES: list[str] = [
    ...
    "leaning back, hands jammed into pockets.",
    ...
    "wiping their hands on their clothes, over and over.",
    ...
    "checking and re-checking empty pockets.",
    "tugging at the cuff of their sleeve.",
    "picking at a stain on their clothing.",
