...
return script
@@ -24,33 +21,46 @@ def at_script_creation(self):
self.interval = 6
...
char = entry["char"]
            if hasattr(char, "ndb") and hasattr(char.ndb, "combat_handler"):
...
return
        initiative = randint(1, max(1, getattr(char, "motorics", 1)))
...
@@ -61,15 +71,19 @@ def add_combatant(self, char, target=None):
...
if len(self.db.combatants) <= 1:
@@ -91,29 +105,32 @@ def get_initiative_order(self):
...
@@ -128,39 +145,21 @@ def at_repeat(self):
if not target:
continue
